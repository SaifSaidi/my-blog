...
<div className="gap-x-4 flex"><div><p><a href="https://www.nuget.org/packages/BlazorImage/" target="_blank" rel="noopener noreferrer"><img className="rounded-lg w-44! h-44" src="https://img.shields.io/nuget/v/BlazorImage.svg?style=flat-square" alt="NuGet version (BlazorImage)" width="800" height="400"></a></p></div><div><p><a href="https://www.nuget.org/packages/BlazorImage" target="_blank" rel="noopener noreferrer"><img className=rounded-lg w-24!" src="https://img.shields.io/nuget/dt/BlazorImage.svg?logo=nuget&amp;label=nuget%20downloads&amp;color=ff5c9b" alt="NuGet downloads (BlazorImage)" width="800" height="400"></a></p></div></div>
